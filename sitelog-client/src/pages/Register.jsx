          ...
          <div className="card shadow-elevated p-6 sm:p-10">
            ...
            <div className="relative mb-4">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="px-4 text-muted font-medium" style={{ background: 'rgb(var(--color-card))', transition: 'background-color 0.35s ease' }}>or register with email</span>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input type="text" value={name} onChange={(e) => setName(e.target.value)} className="input-field !pl-11 py-2.5 text-base" placeholder="John Doe" required />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    disabled={!!inviteData}
                    className={`input-field !pl-11 pr-10 py-2.5 text-base ${inviteData ? 'opacity-60 cursor-not-allowed' : ''} ${emailError ? 'border-danger focus:ring-danger/20' : emailAvailable ? 'border-success focus:ring-success/20' : ''}`}
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} className="input-field !pl-11 py-2.5 text-base" placeholder="Min. 8 characters" required />
                </div>
              ...
              <div>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className={`input-field !pl-11 py-2.5 text-base ${confirmPassword && confirmPassword !== password ? 'border-danger focus:ring-danger/20' : ''}`}
              ...
              <button type="submit" disabled={submitting || emailAvailable === false} className="btn-accent w-full py-3 text-base mt-2">
