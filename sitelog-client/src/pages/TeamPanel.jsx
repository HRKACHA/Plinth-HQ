...
const ROLE_COLORS = {
  site_engineer: 'bg-blue-500/15 text-blue-700 dark:text-blue-400 border-blue-500/30',
  accounts: 'bg-amber-500/15 text-amber-700 dark:text-amber-400 border-amber-500/30',
  owner: 'bg-purple-500/15 text-purple-700 dark:text-purple-400 border-purple-500/30',
  project_manager: 'bg-emerald-500/15 text-emerald-700 dark:text-emerald-400 border-emerald-500/30',
  admin: 'bg-red-500/15 text-red-700 dark:text-red-400 border-red-500/30',
  contractor: 'bg-orange-500/15 text-orange-700 dark:text-orange-400 border-orange-500/30',
  PM: 'bg-emerald-500/15 text-emerald-700 dark:text-emerald-400 border-emerald-500/30',
  SuperAdmin: 'bg-red-500/15 text-red-700 dark:text-red-400 border-red-500/30',
  Engineer: 'bg-blue-500/15 text-blue-700 dark:text-blue-400 border-blue-500/30',
  Owner: 'bg-purple-500/15 text-purple-700 dark:text-purple-400 border-purple-500/30',
  Accounts: 'bg-amber-500/15 text-amber-700 dark:text-amber-400 border-amber-500/30',
};
