    ...
    <div className="card overflow-hidden p-0 mb-4 transition-all duration-300">
      ...
      >
        <div className="overflow-hidden">
          <div className="p-5 border-t border-[var(--subtle-border)] bg-black/[0.20] dark:bg-black/[0.20]" style={{ background: 'var(--accordion-content-bg, rgba(0,0,0,0.20))' }} ref={contentRef}>
            {children}
          </div>
        </div>
      </div>
